...
public class RemoteCenterActivity extends BaseActivity {
    ...
    private void initToolbar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setHomeAsUpIndicator(R.drawable.icon_caidan);//改变启用HomeAsUp按钮按钮的图标
        }
    }
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.nav_menu_message:
                        Toast.makeText(RemoteCenterActivity.this, "消息中心", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.nav_menu_systemlog:
                        Toast.makeText(RemoteCenterActivity.this, "系统日志", Toast.LENGTH_SHORT).show();
                        break;
                }
                ...
                runOnUiThread(new Runnable() { //更新UI线程
                    ...
                    public void run() {
                        ...
                        if (result.rows != null) {
                            ...
                            ToastUtils.showToast(RemoteCenterActivity.this, "已经全部加载");
                        }
